...
BASE_URL = "http://localhost:8080" # Assuming this is where the MCP relay is reachable for tool execution

def check_messages():
    try:
        response = requests.post(f"{BASE_URL}/execute", json={"command": "mcp_quorus_check_messages", "params": {}})
