...
from quorus.backends.protocol import WebhookBackend, WebhookQueueBackend

logger = structlog.get_logger("quorus.services.webhook")
        ...
        async with self._semaphore:
            ...
            try:
                ...
                if secret:
                    ...
                    headers["X-Quorus-Timestamp"] = str(timestamp)
                    headers["X-Quorus-Signature"] = f"sha256={sig}"
