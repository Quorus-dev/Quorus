"""Universal Quorus client — works with any agent platform via HTTP.

Usage:
    from quorus_sdk.http_agent import QuorusClient

    client = QuorusClient("https://your-relay.example.com", name="my-agent", api_key="mct_...")
...
logger = logging.getLogger("quorus.http_agent")
...
class QuorusClient:
    """Lightweight HTTP client for Quorus relay. No MCP dependency."""
