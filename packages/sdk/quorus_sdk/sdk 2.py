"""Quorus SDK — 3 lines to add agent coordination to any project.

Usage:
    from quorus_sdk import Room
...
logger = logging.getLogger("quorus.sdk")


class Room:
    """High-level interface to a Quorus room.
    ...
    def __init__(
        ...
        *,
        ...
        self._client = QuorusClient(relay, secret, name, api_key=api_key)
