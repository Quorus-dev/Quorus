...
# ---------------------------------------------------------------------------
# Phase-1 primitive tools + the approval bridge register themselves against
# ``mcp`` when ``phase1_registry`` is imported (keeps this module under the
# 500-line cap). Import is last so ``mcp`` already exists.
# ---------------------------------------------------------------------------
